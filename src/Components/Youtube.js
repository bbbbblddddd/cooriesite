...
const Youtube = () => {
  ...
  const fallochImageStyle = {
    ...fallochImage,
    ...containerStyle,
    height: isSmallScreen ? "650px" : isMediumScreen ? "1200px" : "1200px",
  };
  

  const fallochImageContainerStyle = {
    ...fallochImageStyle,
    marginTop: isSmallScreen ? "-450px" : isMediumScreen ? "-350px" : "0",
  };
        ...
        <section>
          ...
          >
            ...
            >
              ...
              sustainability projects/exhibitions. <br/> <br/> Funds can be generated from clicks and views, rather than donations.
