...
const Home = () => {
  ...
  return (
    <section>
      <div className="relative bg-cover" style={{ ...waterfallImage, ...containerStyle }}>
  ...
  <div className="flex justify-between mb-4">
    <div className="flex flex-col items-center w-full">
      ...
      <div className="px-10">
        <img className="w-full" src="https://coorieprojectimagesbbbbblddddd.s3.eu-west-2.amazonaws.com/lIekaw4+-+Imgur.jpg" alt="explainer 1" />
      </div>
    ...
    <div className="flex flex-col items-center w-full">
      <h1 className="text-xl">Title 3</h1>
      <div className="px-10">
        <img className="w-full" src="https://coorieprojectimagesbbbbblddddd.s3.eu-west-2.amazonaws.com/lIekaw4+-+Imgur.jpg" alt="explainer 2" />
      </div>
    ...
    <div className="flex flex-col items-center w-full">
      <h1 className="text-xl">Title 3</h1>
      <div className="px-10">
        <img className="w-full" src="https://coorieprojectimagesbbbbblddddd.s3.eu-west-2.amazonaws.com/lIekaw4+-+Imgur.jpg" alt="explainer3" />
      </div>
